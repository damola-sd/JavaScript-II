...
let fullName = [];
runners.forEach(function (element,i = 0) {
    fullName[i].push(element.first_name, element.last_name);
...
ticketPriceTotal.push(runners.map(a => {return a.donation}).reduce(totalTicketPrice));
